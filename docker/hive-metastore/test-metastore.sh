...
$HIVE_HOME/bin/beeline -u "jdbc:hive2://hiveserver2:10000" -e "
...
$HIVE_HOME/bin/beeline -u "jdbc:hive2://hiveserver2:10000" -e "DESCRIBE default.test_table;"

# List tables to confirm
echo "Listing tables in default database..."
$HIVE_HOME/bin/beeline -u "jdbc:hive2://hiveserver2:10000" -e "SHOW TABLES in default;"
